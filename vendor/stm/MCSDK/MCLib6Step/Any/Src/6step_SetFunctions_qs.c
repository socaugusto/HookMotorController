...
extern MC_FuncStatus_t MC_Core_SixStepTableQuasiSyncRect(MC_Handle_t *pMc, uint16_t PulseValue, uint8_t StepNumber);
...
inline MC_FuncStatus_t MC_Core_SetHFPWM(MC_Handle_t *pMc, uint16_t PulseValue, uint8_t StepNumber)
  {
  return MC_Core_SixStepTableQuasiSyncRect(pMc, PulseValue, StepNumber);  
  }
