...
void ADC_ConvCplt_Handler(void)
{
    ...
    {
        MC_Core_ProcessAdcMeasurement((uint32_t *)ADC1,
                                      (uint16_t)LL_TIM_GetCounter((TIM_TypeDef *)((&Motor_Device1)->plf_timer)),
                                      (uint16_t)LL_ADC_REG_ReadConversionData12((ADC_TypeDef *)ADC1));
...
void TIMx_BRK_M1_Handler(void)
{
    ...
    if (LL_TIM_IsActiveFlag_BRK((TIM_TypeDef *)Motor_Device1.phf_timer) &&
        LL_TIM_IsEnabledIT_BRK((TIM_TypeDef *)Motor_Device1.phf_timer))
    {
    ...
    if (LL_TIM_IsActiveFlag_COM((TIM_TypeDef *)Motor_Device1.phf_timer) &&
        LL_TIM_IsEnabledIT_COM((TIM_TypeDef *)Motor_Device1.phf_timer))
    {
...
void HALL_TIM_M1_IRQHandler(void)
{
    ...
    if (LL_TIM_IsActiveFlag_CC1((TIM_TypeDef *)Motor_Device1.plf_timer) &&
        LL_TIM_IsEnabledIT_CC1((TIM_TypeDef *)Motor_Device1.plf_timer))
    {
    ...
    if (LL_TIM_IsActiveFlag_CC2((TIM_TypeDef *)Motor_Device1.plf_timer) &&
        LL_TIM_IsEnabledIT_CC2((TIM_TypeDef *)Motor_Device1.plf_timer))
    {
